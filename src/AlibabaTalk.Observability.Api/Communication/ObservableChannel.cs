...
#pragma warning  restore 0067
        ...
        public void BasicPublish(string exchange, string routingKey, bool mandatory, IBasicProperties basicProperties, ReadOnlyMemory<byte> body)
        {
            ...
            using (System.Diagnostics.Activity activity = activitySource.StartActivity($"Pub:{exchange}:{routingKey}", System.Diagnostics.ActivityKind.Producer, System.Diagnostics.Activity.Current.Context))
            {
                activity.AddEvent(new System.Diagnostics.ActivityEvent("gatwey-query-pub"));
